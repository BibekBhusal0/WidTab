...
export function DragHandlePlugin(
  ...
  function hideDragHandle() {
    if (dragHandleElement) dragHandleElement.classList.add("hide");
  }

  function showDragHandle() {
    if (dragHandleElement) dragHandleElement.classList.remove("hide");
  }
  ...
  addProseMirrorPlugins() {
    return [
      DragHandlePlugin({
        ...
        editorScrollable: this.options.editorScrollable,
